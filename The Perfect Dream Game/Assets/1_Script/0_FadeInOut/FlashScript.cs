...
public class FlashScript : MonoBehaviour
{
    ...
    [SerializeField] private int flash_loopcount = 1;// ループ回数
    public IEnumerator IFlashIn()
    {
        ...
        for (int i = 0; i <= flash_loopcount; i++)// 色を徐々に変えるループ
        {
    ...
    public IEnumerator TFlashIn()
    {
        TextMeshProUGUI fade = GetComponent<TextMeshProUGUI>();//色を変えるゲームオブジェクトからImageコンポーネントを取得
